...
/** @hide */
	...
	public FuelControlRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
	...
	public FuelControlRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == FuelControlRenderer.class)
	...
	public FuelControlRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == FuelControlRenderer.class)
